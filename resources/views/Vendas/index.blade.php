...
<body>
  ...
  <div class="container-fluid">
    ...
    @foreach($vendas as $dados)
        <div class="col-sm-3">
          <div class="card text-center text-bg-light" style="width: 20rem;">
            ...
            <div class="card-body">
              ...
              <a class="btn btn-outline-dark" href="/vendas/comprar/{{$dados['id']}}">Selecionar</a>
            </div>
          </div>
        </div>
    @endforeach
