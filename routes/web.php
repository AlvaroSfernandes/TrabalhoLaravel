...
Route::group(['prefix'=>'produto'], function() {
    ...
    Route::post('/inserir', [ProdutoController::class, 'salvar_novo'])->name('produto.inserir.submit');
    Route::get('/alterar/{id}', [ProdutoController::class, 'alterar']);
    Route::put('/alterar/{id}', [ProdutoController::class, 'alterarProduto'])->name('produto.alterar');
